	...
	float GetAllRadiactive(IEntity ent) {
		...
		IEntity armst_BackpackSlot = armst_loadoutStorage.GetClothFromArea(LoadoutBackpackArea);
			if (armst_BackpackSlot)
				...
				ARMST_ITEMS_STATS_COMPONENTS m_ArmstStat_BackpackSlot = ARMST_ITEMS_STATS_COMPONENTS.Cast(armst_BackpackSlot.FindComponent(ARMST_ITEMS_STATS_COMPONENTS));
				if (m_ArmstStat_BackpackSlot)
						m_fProtectionLevelRadiactive_BackpackSlot = m_ArmstStat_BackpackSlot.GetProtectionToxicLevel();
				}
	...
	float GetAllPsy(IEntity ent) {
		...
		IEntity armst_BackpackSlot = armst_loadoutStorage.GetClothFromArea(LoadoutBackpackArea);
			if (armst_BackpackSlot)
				...
				ARMST_ITEMS_STATS_COMPONENTS m_ArmstStat_BackpackSlot = ARMST_ITEMS_STATS_COMPONENTS.Cast(armst_BackpackSlot.FindComponent(ARMST_ITEMS_STATS_COMPONENTS));
				if (m_ArmstStat_BackpackSlot)
						m_fProtectionLevelPsy_BackpackSlot = m_ArmstStat_BackpackSlot.GetProtectionToxicLevel();
				}
	...
	float GetAllPhysicals(IEntity ent) {
		...
		IEntity armst_BackpackSlot = armst_loadoutStorage.GetClothFromArea(LoadoutBackpackArea);
			if (armst_BackpackSlot)
				...
				ARMST_ITEMS_STATS_COMPONENTS m_ArmstStat_BackpackSlot = ARMST_ITEMS_STATS_COMPONENTS.Cast(armst_BackpackSlot.FindComponent(ARMST_ITEMS_STATS_COMPONENTS));
				if (m_ArmstStat_BackpackSlot)
					m_fProtectionLevelPhysicals_BackpackSlot = m_ArmstStat_BackpackSlot.GetProtectionToxicLevel();
				}
	...
	float GetAllThermo(IEntity ent) {
		...
		IEntity armst_BackpackSlot = armst_loadoutStorage.GetClothFromArea(LoadoutBackpackArea);
			if (armst_BackpackSlot)
				...
				ARMST_ITEMS_STATS_COMPONENTS m_ArmstStat_BackpackSlot = ARMST_ITEMS_STATS_COMPONENTS.Cast(armst_BackpackSlot.FindComponent(ARMST_ITEMS_STATS_COMPONENTS));
				if (m_ArmstStat_BackpackSlot)
					m_fProtectionLevelThermo_BackpackSlot = m_ArmstStat_BackpackSlot.GetProtectionToxicLevel();
				}
	...
	float GetAllElectro(IEntity ent) {
		...
		IEntity armst_BackpackSlot = armst_loadoutStorage.GetClothFromArea(LoadoutBackpackArea);
			if (armst_BackpackSlot)
				...
				ARMST_ITEMS_STATS_COMPONENTS m_ArmstStat_BackpackSlot = ARMST_ITEMS_STATS_COMPONENTS.Cast(armst_BackpackSlot.FindComponent(ARMST_ITEMS_STATS_COMPONENTS));
				if (m_ArmstStat_BackpackSlot)
					m_fProtectionLevelElectro_BackpackSlot = m_ArmstStat_BackpackSlot.GetProtectionToxicLevel();
				}
