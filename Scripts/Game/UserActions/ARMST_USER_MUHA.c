...
class ARMST_USER_MUHA_Toggles_Start_Found : ScriptedUserAction
{	
	...
	override void PerformAction(IEntity pOwnerEntity, IEntity pUserEntity) 
	{
		...
		if(!pUserEntity)
			return;
		DetectorComponents.ArmstArtDetectorStartFound(pUserEntity);
	...
	{
		outName = "#Armst_detector_anal_anomal";
		return true;
	}
	...
	//------------------------------------------------------------------------------------------------
	void ~ARMST_USER_MUHA_Toggles_Start_Found()
	{
	}
};
